...
BEGIN
    ...
    ELSE
        ...
        ELSE
            ...
            INSERT INTO Clientes (dni, cuil, nombre, apellido, sexo, usuario, password, id_pais_nacimiento, fecha_nacimiento, admin, deleteDate, deleted, createDate) 
            VALUES 
            (p_dni, p_cuil, p_nombre, p_apellido, p_sexo, p_usuario, p_password, p_id_pais_nacimiento, p_fecha_nacimiento, p_admin, NULL, 0, CURRENT_TIMESTAMP);
